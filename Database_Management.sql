...
-- 테이블 데이터 Cinema.movie_schedule:~4 rows (대략적) 내보내기
...
INSERT INTO `movie_schedule` (`Schedule`, `Movie_Num`, `Theater_Num`) VALUES
	('09:00,12:00,15:00,19:00', '19960041', '1관'),
	('09:00,12:00,16:00,19:00,22:00', '20226411', '2관'),
	('09:00,12:00,16:00,19:00,22:00', '20231348', '3관'),
	('09:00,12:00,16:00,19:00,22:00', '20231496', '6관');
...
INSERT INTO `reservations` (`Reservation_Num`, `UID`, `Movie_Title`, `Schedule`, `Theater_Num`, `Seat_Num`, `Price`, `Payment_Method`) VALUES
	('230529601', '6', '아기공룡 둘리-얼음별 대모험', '09:00', '1관', 'S-28, S-29', 20000, 'cash'),
	('230529602', '6', '아기공룡 둘리-얼음별 대모험', '09:00', '1관', 'S-20, S-21', 20000, 'cash'),
	('230529603', '6', '아기공룡 둘리-얼음별 대모험', '09:00', '1관', 'S-28, S-29', 20000, 'cash'),
	('230529604', '6', '아기공룡 둘리-얼음별 대모험', '09:00', '1관', 'S-28, S-29', 20000, 'cash'),
	('230529605', '6', '아기공룡 둘리-얼음별 대모험', '09:00', '1관', 'S-28, S-29', 20000, 'cash');
